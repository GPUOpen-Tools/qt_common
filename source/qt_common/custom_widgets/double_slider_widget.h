...
public:
    ...
    /// \param parent The parent of double slider.
    explicit DoubleSliderWidget(Qt::Orientation orientation, QWidget* parent = nullptr);
    ...
    void InitStyleOption(QStyleOptionSlider* option, DoubleSliderWidget::SpanHandle span_handle = DoubleSliderWidget::kUpperHandle) const;
...
private:
    ...
    void DrawHandle(QStylePainter* painter, DoubleSliderWidget::SpanHandle span_handle) const;

    /// Draw the span for this item.
    /// \param painter The painter used to draw span for this item.
    /// \param span_area The area of span.
    void DrawSpan(QStylePainter* painter, const QRect& span_area) const;
    ...
    DoubleSliderWidget::HandleMovementModeType handle_movement_;        ///< movement of handle
