...
static const QColor kRulerMarkerColor     = QColor(51, 51, 51);
static const QColor kRulerEdgeColor       = QColor(230, 230, 230);
static const QColor kRulerBackgroundColor = QColor(248, 248, 248);
static const float  kRulerFontPointSize   = 8.25f;

void RulerWidget::PaintRulerBackground(QPainter* painter, const QRectF& rect)
{
    painter->setPen(kRulerEdgeColor);
    painter->setBrush(kRulerBackgroundColor);
